...
#define VERSION_STRING "ULTIMAKER:BATCH=1,PCB=1.5.3,ATMEGA=2560 FW:V=1.1,BUILD=1 E0:TC597=1,SPEED=14 Z:PITCH=3MM"
...
//#define FANCY_LED_PWM_MULTIPLY 1.0 // in case you run everything at a voltage higher than 12V!
...
#define SLOW_XY_FEEDRATE 1800 // Speed from which to start accelerating
